    ...
    "inbounds": [
        {
            ...
            "streamSettings": {
                ...
                "realitySettings": {
                    ...
                    "xver": 0,
                    "serverNames": [
                        "playback.newbuy.chinaunicom.cn"
                    ],
...
EOF
    ...
    IP=$(getIP)
    url="vless://${UUID}@${IP}:${PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=playback.newbuy.chinaunicom.cn&fp=chrome&pbk=${rePublicKey}&sid=${shortId}&type=tcp&headerType=none#$ISP"
