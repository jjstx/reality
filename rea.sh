    ...
    "inbounds": [
        {
            ...
            "streamSettings": {
                ...
                "realitySettings": {
                    ...
                    "xver": 0,
                    "serverNames": [
                        "chinaunicom-playe-free.10010.com"
                    ],
...
EOF
    ...
    IP=$(getIP)
    url="vless://${UUID}@${IP}:${PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=chinaunicom-playe-free.10010.com&fp=chrome&pbk=${rePublicKey}&sid=${shortId}&type=tcp&headerType=none#$ISP"
