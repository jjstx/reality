    ...
    "inbounds": [
        {
            ...
            "streamSettings": {
                ...
                "realitySettings": {
                    ...
                    "xver": 0,
                    "serverNames": [
                        "wolive-pull.chinaunicomvideo.cn"
                    ],
...
EOF
    ...
    IP=$(getIP)
    url="vless://${UUID}@${IP}:${PORT}?encryption=none&flow=xtls-rprx-vision&security=reality&sni=wolive-pull.chinaunicomvideo.cn&fp=chrome&pbk=${rePublicKey}&sid=${shortId}&type=tcp&headerType=none#$ISP"
